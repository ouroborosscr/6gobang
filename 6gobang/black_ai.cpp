...
black_ai::black_ai(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::black_ai)
{
    ui->setupUi(this);
...
void black_ai::showEvent(QShowEvent* )
{
    for(int i=1;i<=21;i++)
        for(int j=1;j<=21;j++)
        {
...
void black_ai::closeEvent(QCloseEvent *)
{
    emit ExitWin();
}

void black_ai::mousePressEvent(QMouseEvent *event)
{
    myjudgement judge;
    warning44 warn44;
    warnin55 warn55;
...
//                    mypieces_score[i][j]+=black_rush_2(i,j);
                    ...
                    //判断禁手（自动不下）
                    if(white_live_5(i,j)>=3216)
                        mypieces_score[i][j]=0;
                    if(white_live_4(i,j)>=198)
                        mypieces_score[i][j]=0;
...
int black_ai::white_6(int x, int y)
{
...
int black_ai::black_5(int x, int y)
{
    int h=0,s=0,zx=0,fx=0;
    int re=0;
    //横
...
int black_ai::white_live_5(int x, int y)
{
...
int black_ai::black_live_4(int x, int y)
{
    int h=0,s=0,zx=0,fx=0;
    int re=0;
...
int black_ai::white_rush_5(int x, int y)
{
    int h=0,s=0,zx=0,fx=0;
    int re=0;
    mypieces_color[x][y]=2;
...
int black_ai::black_rush_4(int x, int y)
{
    int h=0,s=0,zx=0,fx=0;
    int re=0;
    int w=0,k=0;
...
int black_ai::white_live_4(int x, int y)
{
    int h=0,s=0,zx=0,fx=0;
    int re=0;
    mypieces_color[x][y]=2;
...
int black_ai::black_live_3(int x, int y)
{
...
int black_ai::white_rush_4(int x, int y)
{
    int h=0,s=0,zx=0,fx=0;
    int re=0;
    mypieces_color[x][y]=2;
...
int black_ai::black_rush_3(int x, int y)
{
    int h=0,s=0,zx=0,fx=0;
    int re=0;
    int w=0,k=0;
...
int black_ai::white_live_3(int x, int y)
{
    int re=0;
    //直接列
    //横
...
int black_ai::black_live_2(int x, int y)
{
    int re=0;
    //直接列
    //横
...
int black_ai::white_rush_3(int x, int y)
{
    int re=0;
    //直接列
    //横
...
int black_ai::white_live_2(int x, int y)
{
    int re=0;
    //横
...
int black_ai::black_live_1(int x, int y)
{
    int re=0;
...
int black_ai::white_rush_2(int x, int y)
{
    int re=0;
    mypieces_color[x][y]=2;
    //横
